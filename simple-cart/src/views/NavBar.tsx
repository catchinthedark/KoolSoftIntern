...
import { SelectLoginStatus } from "../features/users/usersSlice"
...
const NavBar = () => {
    ...
    return (
        <nav className="navbar">
            ...
            <Link to="/category" className="tag">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="white" className="bi bi-list-columns" viewBox="0 0 16 16">
            ...
            <Link to="/add-product" className="tag">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="white" className="add-product" viewBox="0 0 16 16">
                    <path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/>
                    <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
                </svg>
            </Link>
            <Link to="/cart" style={{ textDecoration: 'none' }} className="tag"> 
                <div className="cart">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="white" className="bi bi-bag-fill" viewBox="0 0 16 16">
                        <path d="M8 1a2.5 2.5 0 0 1 2.5 2.5V4h-5v-.5A2.5 2.5 0 0 1 8 1zm3.5 3v-.5a3.5 3.5 0 1 0-7 0V4H1v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V4h-3.5z"/>
                    </svg>
                    <span className="cart-quantity">
                        <span>{cartQuanity}</span>
                    </span>
                </div>
            </Link>
            {login ? 
                <Link to="/profile" style={{ textDecoration: 'none' }} className="tag">
